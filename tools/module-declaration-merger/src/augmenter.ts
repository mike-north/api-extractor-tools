...
function generateAugmentationSection(
  ...
  sections.push('')
  sections.push('// ============================================')
  sections.push('// Module Declarations (merged by module-declaration-merger)')
  sections.push('// ============================================')
  sections.push('')
...
export function augmentRollups(options: AugmentOptions): AugmentResult {
  ...
  const addToApiReportFile =
    missingReleaseTagConfig?.addToApiReportFile ?? false
